...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="AI Local Business Reputation Suite Dashboard"
      subtitle="One merged ai local business reputation view for Review Requests, Review Replies, Google Business Posts, Local SEO, Feedback Inbox, Testimonial Library, Brand Tone, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared ai local business reputation jobs into one surface. Review Requests, Review Replies, Google Business Posts, Local SEO, Feedback Inbox, Testimonial Library, Brand Tone, source tables, documents, audit, and AI are presented as platform features.
          </div>
