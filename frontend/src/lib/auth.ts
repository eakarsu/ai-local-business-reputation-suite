export const AUTH_COOKIE = 'ai_local_business_reputation_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@ai-local-reputation.local',
    password: 'admin123',
    firstName: 'Suite',
    lastName: 'Admin',
    role: 'admin',
  ...
  {
    email: 'manager@ai-local-reputation.local',
    password: 'manager123',
    firstName: 'Suite',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@ai-local-reputation.local',
    password: 'analyst123',
    firstName: 'Suite',
    lastName: 'Analyst',
    role: 'analyst',
